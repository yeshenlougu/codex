...
help:
	...
	@echo ""
	@echo "Workflow Commands (CLI):"
	@echo "  codex-go spec new <name>     Create a spec template"
	@echo "  codex-go spec show [file]    View a spec"
	@echo "  codex-go plan generate       Generate PLAN.md from SPEC.md"
	@echo "  codex-go plan list           Show task status"
	@echo ""
	@echo "Interactive Slash Commands:"
	@echo "  /spec <desc>    Generate SPEC from description"
	@echo "  /plan [spec]    Generate plan from spec"
	@echo "  /tasks          Show task list"
	@echo "  /implement <n>  Mark task N as done"
